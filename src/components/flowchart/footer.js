...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/FlowchartGPT');
  ...
  return (
    <footer className="mt-188px w-full relative z-10">
        ...
        <div className="flex justify-between items-start">
          ...
          <div>
            ...
            <div className="text-black mb-4 text-2xl font-bold font-sans">
              Build your own FlowchartGPT
            </div>
            <div className="flex items-center gap-4">
              <Link
                href="https://github.com/0xmetaschool/FlowchartGPT/fork"
              ...
              <div className="flex items-center">
                <Link 
                  href="https://github.com/0xmetaschool/FlowchartGPT"
                  className="flex items-center gap-2 px-4 py-2 rounded-md border border-gray-200 hover:bg-black hover:text-white transition-colors text-xs z-10"
                >
                ...
                <div className="ml-[-10px] bg-white border border-gray-200 rounded-md px-3 py-1 text-sm">
                  {starCount}
                </div>
              </div>
            </div>
